...
// border-none ingår inte i BASE — Tailwind preflight nollställer knapp-border.
// Varianterna ansvarar själva för om de vill ha border eller inte.
const BASE = 'inline-flex items-center gap-1.5 rounded-[6px] text-[13px] font-medium min-h-[44px] px-[18px] leading-none transition-all duration-150 whitespace-nowrap [-webkit-tap-highlight-color:transparent] disabled:opacity-50 disabled:cursor-not-allowed';
